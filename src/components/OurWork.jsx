...
import Title from './Title'  // Make sure Title.jsx is in the same folder as OurWork.jsx
...
const OurWork = () => {
  const workData = [
    ...
    },
    {
      ...
      description: "We help you execute your plans and delivered results",
      image: assets.work_dashboard_management
    },
    {
      id: 3,
      title: "Fitness app promotion",
      description: "We help you create a marketing stategy that delivers results",
